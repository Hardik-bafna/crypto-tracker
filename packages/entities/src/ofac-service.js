...
export class OFACSanctionsService {
    ...
    async loadLiveSanctionsList() {
        ...
        this.loadPromise = (async () => {
            ...
            let totalLoaded = 0;
            const results = await Promise.allSettled(feedEntries.map(async ([chain, url]) => {
                try {
    ...
    createOfacEntity(address) {
        ...
        return {
            ...
            description: "This address is officially listed on the US Department of the Treasury " +
...
//# sourceMappingURL=ofac-service.js.map